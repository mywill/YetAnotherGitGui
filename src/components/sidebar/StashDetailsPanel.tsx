  ...
  return (
    <div ref={containerRef} className="stash-details-panel flex h-full flex-col overflow-hidden">
      ...
      <div className="files-section flex min-h-0 flex-1 flex-col overflow-hidden">
        <div className="files-header border-border bg-bg-well text-text-muted text-3xs flex shrink-0 items-center justify-between border-b px-3 py-2 font-mono font-medium tracking-widest uppercase">
